...
async def test_get_paginated_basic(repository, populated_db):
    ...
    # Act
    total_count, results = await repository.get_paginated(filters=filters)
...
async def test_get_paginated_different_pages(repository, populated_db):
    ...
    # Act
    total_count1, page1_results = await repository.get_paginated(filters=filters_page1)
    total_count2, page2_results = await repository.get_paginated(filters=filters_page2)
