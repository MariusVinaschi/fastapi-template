...
3. Review the changed files first, then inspect adjacent definitions needed to prove findings.
4. Report only actionable issues with file and line references when available.
